...
export type ResponseRequest = InternalError;
...
export const createSuccessResponse = (internalCode: string, statusCode: number) => (
  message: string
): ResponseRequest => ({ message, internalCode, statusCode });
